    ...
    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4 mt-2">
        ...
        <div class="col">
            <div class="card h-100 product-card shadow-sm border-0">
                <span class="badge badge-cate rounded-pill px-3 bg-success text-white">
                    {{ $product->category->name ?? 'Trái cây' }}
                </span> <img src="{{ $product->image ? asset('images/' . $product->image) : 'https://placehold.co/400x400?text=' . $product->name }}" class="card-img-top" alt="{{ $product->name }}">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('product.detail', $product->id) }}"
                            class="btn btn-success text-white w-100 py-2 rounded-pill shadow-sm">
                            Mua ngay
                        </a>
                    </div>
                </div>
